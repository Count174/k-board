/**
 * Регистрация всех обработчиков и cron-задач Telegram-бота.
 * Вызывается из bot/index.js после создания экземпляра с { polling: false } (режим webhook).
 */
...
module.exports = registerTelegramBot;